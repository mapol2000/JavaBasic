...
public class FileReaderWriter2 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // 구성된 2차원 표 형태의 데이터를 student.dat에
        // 저장
        ...
        // 구성된 2차원 표 형태의 데이터를 subject.dat에
        // 저장
        int sNo = 0205;
        String sName = "프로그래밍";
        String sDetail = "자바 프로그래밍";
        int sProf = 301;
        ...
        fmt = "%s, %s, %s, %s";
        data = String.format(fmt, sNo, sName, sDetail, sProf);
